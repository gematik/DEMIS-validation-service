...
import static de.gematik.demis.validationservice.util.ResourceFileConstants.INVALID_PARAMETERS_META_EXCEPTION;
import static de.gematik.demis.validationservice.util.ResourceFileConstants.INVALID_REPORT_BED_OCCUPANCY_EXAMPLE;
import static de.gematik.demis.validationservice.util.ResourceFileConstants.INVALID_TEST_NOTIFICATION_DV_2;
import static de.gematik.demis.validationservice.util.ResourceFileConstants.NOT_PARSEABLE_REPORT_BED_OCCUPANCY_EXAMPLE;
import static de.gematik.demis.validationservice.util.ResourceFileConstants.VALID_BUNDLE_WITH_UNDERSCORES_EXAMPLE;
import static de.gematik.demis.validationservice.util.ResourceFileConstants.VALID_REPORT_BED_OCCUPANCY_6_0_0;
import static de.gematik.demis.validationservice.util.ResourceFileConstants.VALID_REPORT_BED_OCCUPANCY_JSON_EXAMPLE;
...
class ValidationServiceIntegrationProfileTest {
  ...
  class ValidationWithMultipleProfilesVersions {
    ...
    void invalidWithAllVersions() throws IOException {
      ...
      final var errorsOrFatalIssues = getErrorOrFatalIssues(operationOutcome);
      assertThat(errorsOrFatalIssues).hasSize(4);
    }
  }
}
